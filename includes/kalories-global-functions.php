 ...
 */
function kalories_get_max($array) {

	return Kalories_Globals::get_max($array);
 ...
 */
function kalories_get_svg($svg) {

	return Kalories_Globals::get_svg($svg);
 ...
 */
function kalories_get_template($name) {

	return Kalories_Globals::get_template($name);

}

class Kalories_Globals {
	 ...
	 */
 	...
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters('kalories-template-paths', $locations);
